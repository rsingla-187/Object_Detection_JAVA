...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun getCapturedImage(): Bitmap {
        ...
        bitmap =  convert256x256(bitmap)
        val encodedImageString:String? = encodeBitmapBase64(bitmap);
        val trghgt:String=targetH.toString()
        val trgwdt:String=targetW.toString()
        val cordinate = CordinatesData();
        cordinate.getCordinatesData(encodedImageString,trghgt,trgwdt);
        return bitmap;
    }
    ...
    private fun encodeBitmapBase64(bitmap: Bitmap?):String? {
        ...
        //val imageString: String = Base64.EncoderencodeToString(imageBytes, Base64.DEFAULT)
        //   val imageString: String = Base64.getEncoder().encodeToString(imageBytes);
        val imageString: String = Base64.encodeToString(imageBytes, Base64.DEFAULT);
        return imageString
    }

    private fun convert256x256(bitmap: Bitmap?): Bitmap? {
